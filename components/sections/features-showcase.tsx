...
const features: Feature[] = [
  {
    ...
    videoSrc: "/videos-features/document-upload.mp4",
  ...
  },
  {
    ...
    videoSrc: "/videos-features/intelligent-conversations.mp4",
  ...
  },
  {
    ...
    videoSrc: "/videos-features/no-code-config.mp4",
  ...
  },
  {
    ...
    videoSrc: "/videos-features/accounts-saved-chats.mp4",
  ...
  },
  {
    ...
    videoSrc: "/videos-features/whatsapp.mp4",
  ...
  },
  {
    ...
    videoSrc: "/videos-features/pro-features.mp4",
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="flex-1 w-full max-w-md">
                <div className="relative rounded-xl overflow-hidden shadow-2xl border-8 border-border/50">
                  <video
                    autoPlay
                    loop
                    muted
              ...
              <div className="flex-1 w-full space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="text-2xl lg:text-3xl font-bold underline">
                    {feature.title}
                  </h3>
                </div>
